...
Before a formal submission, update the author metadata in `paper.md` with the
final author names, affiliations, and ORCID identifiers. Also update the research
impact statement with any external use, integrations, publications, or corpus
results that are true at submission time.

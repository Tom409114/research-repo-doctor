...
- rrdoctor package: PyPI `rrdoctor==0.2.17`
...
uvx --from rrdoctor==0.2.17 rrdoctor scan nanoGPT \
  --profile standard \
  --format json \
...
Two original first-run trust failures are absent in the v0.2.17 scan:

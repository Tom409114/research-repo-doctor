...
Please do not open a public issue for suspected credential exposure, secret masking bypasses, or report-generation leaks. Email the maintainer contact listed on the GitHub repository once the public repo is launched.
